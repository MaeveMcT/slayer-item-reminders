...
- Required-item checks run locally. Drop-table recommendations are retrieved asynchronously from the OSRS Wiki.
- Persistent caching is deferred until after the MVP.
...
- Bank close resets manual dismissal and causes current inventory and equipment to be evaluated.
